...
export const SystemStatusBar: React.FC = () => {
  return (
    <motion.div 
      ...
      className="fixed top-24 left-1/2 -translate-x-1/2 z-40 flex items-center gap-6 px-6 py-2.5 glass-panel rounded-full text-xs font-mono text-secondary/80 shadow-[0_4px_30px_rgba(0,0,0,0.5)] border border-white/[0.08]"
    >
